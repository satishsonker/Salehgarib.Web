  ...
  return (
    <>
       ...
       <Link to="/employee-details?title=sticher"><DashboardCard title="Total Expenses" subtitle="Amount" value={dashboardData?.expenses} colorClass="bg-gradient-cr2" icon="bi-people-tools"></DashboardCard></Link>
        <Link to="/employee-details?type=employee"><DashboardCard title="Total Suppliers" subtitle="Amount" value={dashboardData?.suppliers} colorClass="bg-gradient-purple" icon="bi-person-badge-fill"></DashboardCard></Link>
        <Link to="/employee-details?type=staff"><DashboardCard title="Total Stocks" subtitle="Amount" value={dashboardData?.stocks} colorClass="bg-gradient-success" icon="bi-file-earmark-person"></DashboardCard></Link>
        ...
        <Link to="/employee-details?title=machine_emb"><DashboardCard title="Total VISA Exp" subtitle="Amount" value={dashboardData?.expCash} colorClass="bg-gradient-cr1" icon="bi-hand-index-thumb"></DashboardCard></Link>
