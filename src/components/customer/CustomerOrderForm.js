...
export default function CustomerOrderForm({ userData, orderSearch, resetOrderForm }) {
    ...
    const validateCreateOrder = () => {
        ...
        if (new Date(orderDate).setTime(0,0,0) > new Date().setTime(0,0,0)) errors.orderDate = validationMessage.orderFutureDateIsNotAllowed;
        return errors;
    }
    ...
    const validateSaveOrder = () => {
        ...
        if (new Date(orderDate).setTime(0,0,0) > new Date().setTime(0,0,0)) errors.orderDate = validationMessage.orderDateInFutureError;
    ...
    return (
        <>
                ...
                <div className="form-horizontal form-material">
                    <div className="card">
                        <div className="card-body">
                            ...
                            {!showPrintButton && <div className="row g-2">
                            ...
                            {showPrintButton && <>
                            <ButtonBox type="back" onClickHandler={e=>{setShowPrintButton(false)}} className="btn-sm"></ButtonBox>
                                <PrintOrderReceiptPopup setPrintReceiptHandler={setPrintReceiptHandler} showInPupop={false} orderId={orderDataToPrint?.id} modelId={orderDataToPrint?.id} />
                            </>}
                        </div>
                    </div>
                </div>
            ...
            <div className="modal-footer">
                ...
                <PrintOrderReceiptPopup setPrintReceiptHandler={setPrintReceiptHandler} orderId={orderDataToPrint?.id} modelId={orderDataToPrint?.id} />
            </div>
        </>
    )
}
