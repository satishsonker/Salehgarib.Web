                ...
                <ReactToPrint
                    ...
                    pageStyle={`
                        @media print {
                          @page {
                            size: A4;
                            margin:5mm; /* Customize page margins */
                          }
                          .print-page {
                            page-break-after: always; /* Ensure each page breaks after the third item */
                          }
                        }
                      `}
                />
            ...
            <div ref={printRef} style={{ padding: '10px', fontSize: '10px' }} className="row">

                {
                    mainData?.orderDetails?.map((ele, index) => {
                        return <>
                            {index % 3 === 0 && index !== 0 && (
                                <div className="print-page"></div> /* Add a break after every 3 items */
                            )}
                            <div key={ele.id} className="col-9" style={{ height: '370px', maxHeight: '370px' }}>
                                    ...
                                    <div className='row'>
                                        <div className='col-12'>
                                            <table className='table table-bordered'>
                                                <tbody>
                                                    <tr>
                                                        <td colSpan={6} className="text-center"> {process.env.REACT_APP_COMPANY_NAME} {process.env.REACT_APP_COMPANY_SUBNAME}</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td rowSpan={2} colSpan={4}>.<br />Check and updated by............</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
