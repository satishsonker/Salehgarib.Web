    ...
    return (
        <div className='row '>
            <div className='col-4 py-2'>
                ...
                <div className='text-start fw-bold' style={{ fontSize: companyNameFontSize }}>{process.env.REACT_APP_COMPANY_SUBNAME}</div>
                ...
                <div className='text-start' style={{ fontSize: fontSize }}>Mobile : +971567800165</div>
            </div>
            <div className='col-4 py-2'>
            ...
            <div className='col-4 py-2'>
                ...
                <div className='text-end fw-bold' style={{ fontSize: companyNameFontSize }}>الخياطة والتطريز</div>
                ...
                <div className='text-end' style={{ fontSize: fontSize }}>هاتف : ۰۲-٤٤۳٦٥۳۰</div>
                <div className='text-end' style={{ fontSize: fontSize }}>محمول : +۹۷۱٥٦۷۸۰۰۱٦٥</div>
            </div>
        </div>
    )
}