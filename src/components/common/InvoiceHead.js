        ...
        <div className='row '>
            ...
            <div className='col-4 py-2'>
                <div className='text-center'>
                    ...
                    <div className='text-center text-capitalize fw-bold' style={{fontSize:fontSize}}>Tailoring &amp; Embroidery</div>
            ...
            <div className='col-4 py-2'>
                ...
                <div className='text-end fw-bold' style={{fontSize:fontSize}}>ص. ب : 61975</div>
